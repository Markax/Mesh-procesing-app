function [currentDir] = BATCH_MLMakeTemplate(currentDir, x, y)
%   Modificación de Juan para que se pueda llamar a MLMakeTemplate
%   en batch
%   
...
%[name, currentDir] = uigetfile({'*.mat','Matlab .mat files'},'Select File to Make Template',currentDir);
%if (isnumeric(name))
