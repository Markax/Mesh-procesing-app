...
function [currentDir] = BATCH_MLMakeModels(currentDir, modelo_suavizado, x,y,z)
% Modificado por Juan para poder ser llamado en BATCH
...
%     facenum = size(faces,1);
    ...
    final_name = new_name; % Añadido por Juan para procesamiento en BATCH a partir de _des.mat y no reg_.mat
...
%currentDir = new_name;
%currentDir = final_name; % modificado por Juan para que devuelva el _des.mat y no el _reg.mat
currentDir = fullfile(currentDir,final_name);
