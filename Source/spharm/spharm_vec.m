...
%% MODIFICADO POR JUAN
d = max(1, floor(sqrt(vertnum)-1));
%d = max_d; % prueba de Juan para ver si permitiendo grados superiores se
%obtienen mejores reconstrucciones, pero sale lo mismo
%% FIN MODIFICACO POR JUAN
